...
import os
from .repvgg import create_RepVGG_B3


class RepVGG_B3(nn.Module):
    def __init__(self, class_num=62):
        super(RepVGG_B3, self).__init__()
        pr_model = create_RepVGG_B3(deploy=False)
        pr_model.load_state_dict(torch.load('./model/RepVGG/RepVGG-B3-train.pth'))
    ...
    def save(self, circle):
        name = "./weights/RepVGG_B3" + str(circle) + ".pth"
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('./RepVGG/RepVGG-B3-train.pth'))
    print(model)
    model1 = nn.Sequential(
        model.stage0,   # 64 (2,2) (224,224)->(112,112)
        model.stage1,   # 192 (2,2) (112,112)->(56,56)
        model.stage2,   # 384 (2,2) (56,56)->(28,28)
        model.stage3,   # 768 (2,2) (28,28)->(14,14)
