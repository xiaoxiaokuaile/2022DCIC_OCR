...
import os
from .repvgg import create_RepVGG_B3g4


class RepVGG_B3g4(nn.Module):
    def __init__(self, class_num=62):
        super(RepVGG_B3g4, self).__init__()
        pr_model = create_RepVGG_B3g4(deploy=False)
        pr_model.load_state_dict(torch.load('./model/RepVGG/RepVGG-B3g4-train.pth'))
    ...
    def save(self, circle):
        name = "./weights/RepVGG_B3g4" + str(circle) + ".pth"
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('./RepVGG/RepVGG-B3g4-train.pth'))
    print(model)
